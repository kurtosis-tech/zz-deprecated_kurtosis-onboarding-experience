...
var SimpleStorageMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func (_SimpleStorage *SimpleStorageCaller) Num(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SimpleStorage.contract.Call(opts, &out, "num")
...
//
// Solidity: function num() view returns(uint256)
func (_SimpleStorage *SimpleStorageSession) Num() (*big.Int, error) {
	return _SimpleStorage.Contract.Num(&_SimpleStorage.CallOpts)
}

// Num is a free data retrieval call binding the contract method 0x4e70b1dc.
//
// Solidity: function num() view returns(uint256)
func (_SimpleStorage *SimpleStorageCallerSession) Num() (*big.Int, error) {
	return _SimpleStorage.Contract.Num(&_SimpleStorage.CallOpts)
}

// Set is a paid mutator transaction binding the contract method 0x60fe47b1.
//
// Solidity: function set(uint256 _num) returns()
func (_SimpleStorage *SimpleStorageTransactor) Set(opts *bind.TransactOpts, _num *big.Int) (*types.Transaction, error) {
	return _SimpleStorage.contract.Transact(opts, "set", _num)
}

// Set is a paid mutator transaction binding the contract method 0x60fe47b1.
//
// Solidity: function set(uint256 _num) returns()
func (_SimpleStorage *SimpleStorageSession) Set(_num *big.Int) (*types.Transaction, error) {
	return _SimpleStorage.Contract.Set(&_SimpleStorage.TransactOpts, _num)
}

// Set is a paid mutator transaction binding the contract method 0x60fe47b1.
//
// Solidity: function set(uint256 _num) returns()
func (_SimpleStorage *SimpleStorageTransactorSession) Set(_num *big.Int) (*types.Transaction, error) {
	return _SimpleStorage.Contract.Set(&_SimpleStorage.TransactOpts, _num)
}
